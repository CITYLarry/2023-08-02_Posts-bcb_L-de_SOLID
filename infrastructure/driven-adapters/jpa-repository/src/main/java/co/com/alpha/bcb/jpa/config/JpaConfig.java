package co.com.alpha.bcb.jpa.config;

import co.com.alpha.bcb.jpa.config.DBSecret;
...
public class JpaConfig {
    ...
    @Bean
    public DBSecret dbSecretJpa(Environment env) {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        em.setPackagesToScan("co.com.alpha.bcb.jpa");
